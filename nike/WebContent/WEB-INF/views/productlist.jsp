...
<!--side menu끝-->
    ...
    <div id="product_CT">
     <div id="productCenter">
       <div id="Categoryin">
         <ul>
          <li><a href="#"><img id="_NK31093885_AH3378-104_" src="http://image.nike.co.kr/goods/31/09/38/85/AH3378_COL_AH3378-104_180.png" alt="나이키 시티 포토 티 ‘SEOUL’"></a></li>
           <li class="color">
           ...
           <li class="product_name"><a href="#">나이키 시티 포토 티'SEOUL'</a></li>
           <li>>MEN의류 탑&amp;티셔츠</li>
          <li class="price">45.000</li>
         </ul>
       </div>
      </div>
     </div>
